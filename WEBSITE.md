...
платформу, Ed25519-подпись metadata и доступность установщика/portable.
...
Установщик 0.11.1: 60 857 068 байт (58,0 МиБ, привычная подпись «МБ»), анонимный HEAD — 200.
